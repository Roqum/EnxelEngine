...
{
    VkDeviceSize bufferSize = sizeof(m_VkVertices[0]) * m_VkVertices.size();
    VkBuffer stagingBuffer;
    VkDeviceMemory stagingBufferMemory;
    CreateBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMemory);
    void* data;
    vkMapMemory(m_VkDevice, stagingBufferMemory, 0, bufferSize, 0, &data);
    memcpy(data, m_VkVertices.data(), (size_t)bufferSize);
    vkUnmapMemory(m_VkDevice, stagingBufferMemory);
...
{
    VkDeviceSize bufferSize = sizeof(m_VkIndices[0]) * m_VkIndices.size();
    ...
    void* data;
    vkMapMemory(m_VkDevice, stagingBufferMemory, 0, bufferSize, 0, &data);
    memcpy(data, m_VkIndices.data(), (size_t)bufferSize);
    vkUnmapMemory(m_VkDevice, stagingBufferMemory);
